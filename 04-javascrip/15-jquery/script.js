...
$(function () {
    $("#load").on("click", function () {
        ...
        */
        $.ajax("liste.json")
            .done(function (data) {
                ...
                */
                ...
                data.forEach(d => {
                    ...
                    ! attention a la methode appendTo de jQuery qui inversé par rapport au append du js.
                    */
            ...
            .always(() => console.log("chargement terminé"));
    });
    $("#anime").on("click", function () {
        ...
        $(this).css("position", "absolute");
         /*
        la fonction animate de jsquery differe a celle de js.
        elle se contente de prendre en premier argument, un objet contenant les valeurs modifier.
        et en second la duree de l'anim.
        on notera qu'on peut lui donner des valeurs a augmenter ou diminuer.
        */
