...
console.log(a5);
// sans le spread operator, on se retrouve avec un tableau multidimensionnel( un tableau dans un tableau)
let a6 = ["pizza", a4, "pomme", "banane"];
// Pour acceder a une valeur d'un tableau milti dimensionnel, on selectionnera d'abord celui ci avant d'ajouter l'index voulu dans le second tableau.
console.log(a6[1][2]);
// On peut avoir autant de tableaux dans un tableau.
let a7 = [[[[[["coucou"]]]]]];
console.log(a7, a7[0][0][0][0][0][0]);

// pour echanger la position de deux valeurs dans un tableaux, on pourra evidement utiliser une variable temporaire.

let tmp = a6 [0];
a6[0] = a6[3];
a6[3] = tmp;
console.log(a6);
// Mais javascrip permet aussi de le faire ainsi :
[a6[0], a6[1]] = [a6[1], a6[0]];
console.log(a6);
...
/*
    Les object JS ressemble au tableaux mais utilisent {} au lieu de [].
    et au lieu d'etre indexé numeriquement, ils sont indexé par string qui servent de nom de proprieté?
    on pourra par exemple dire que la propriet""nom" vaudra "dupont"
*/
let o1 = {nom: "Dupont", age: 45,loisir:["bowling", "mahjong"] };
console.log(o1);
//pour acceder a une propriete d'un objet, je peux , je peux le faire avec un tableau:
console.log(o1["nom"],o1["age"], o1["loisir"]);
// mais les objects peuvent aussi etre utilisé ains:
console.log(o1.nom, o1.age, o1.loisir);
// ici dans le premier cas il va chercher la valeur de "v" et dans le second, il cherche une propriete "v"  
let v = "age";
console.log(o1[v],o1.v);
// si on veut acceder a un tableau dans un objet, on peut aussi faire ceci:
console.log(o1.loisir[0], o1.loisir[1]);

let o2 = {
    vegetal: { legume :{haricot: {couleur:"vert"}}}
}
...
o4.signe ="scorpion";
console.log(o1, o4);
// on peut aussi se servir du spread oprerator pour transformer un objet en tableau:

console.log(a1, {...a1});

o4.yeux = "vert";
/* dans le cas d'une fusion object, les proprites uniques seront ajouté, et celles en commun , se verront remplacer par la derniere. */
let o5 = {...o4, ...o1};
console.log(o5);
// meme dans un const, un tableau ou un object est modifiable:
const a0 = [], o0 = {};
a0 [0] = "coucou";
o0.text = "coucou";
console.log(a0, o0);
...
// ? -------------- Les booleans -------------------
// les booleans n'accepten que deux valeurs, soit "true" soit "false".
let b1 = true, b2 = false;

// On peut faire apparaitre des booleans de tout un tas de facon:
console.log("1<2", 1<2);
console.log("1>2", 1>2);
// plus petit ou egale, plus grand ou egale:
console.log("1<=2", 1<=2);
console.log("1>=2", 1>=2);
// verifier une egalité:
console.log("1==1", 1==1);
console.log("1== '1':", 1=='1');
// verifier une egalité strict:
console.log("1===1", 1===1);
console.log("1=== '1':", 1==='1');
// verifier la difference, ou la difference strict:
console.log("1!=1:", 1!='1');
console.log("1!= '1':", 1!=='1');

// On peut inverser un resultat en le faisant preceder d'un "!":
console.log("b1:", b1, "b2", b2);
console.log("!b1:", !b1, "!b2", !b2);
// On peut regroupper les booleans avec les opperateurs "et" et "ou" representé par le symbole "&&" et "||":
console.log(true && true, true && false, false && true, false && false);
console.log(true || true, true || false, false || true, false || false);
// On peut ajouter des parenthese a tout cela:
console.log(true&&(true||true), true&&(true||false), false&&(true||true), false&&(false||true));

// On peut court-circuiter un code avec ces comparateurs:
let nb = 0;
// dans le cas d'un &&, si le premier est faux , le second ne sera pas verifier:
